...
% arquivo = fopen('C:/Users/Ricardo Santos/Desktop/PSO_float/resultados/P.txt');
% % A = fscanf(arquivo,'%f',[colunas linhas]);
% P = fscanf(arquivo,'%f',[particulas K]);
% fclose(arquivo);
% clear arquivo

arquivo = fopen('C:/Users/Ricardo Santos/Documents/PSO_float/resultados/SNR.bin');
% A = fscanf(arquivo,'%f',[colunas linhas]);
SNR = fscanf(arquivo,'%f');
fclose(arquivo);
clear arquivo

arquivo = fopen('C:/Users/Ricardo Santos/Documents/PSO_float/resultados/jPgbest.bin');
% A = fscanf(arquivo,'%f',[colunas linhas]);
...
arquivo = fopen('C:/Users/Ricardo Santos/Documents/PSO_float/resultados/SNIR.bin');
% A = fscanf(arquivo,'%f',[colunas linhas]);
...
arquivo = fopen('C:/Users/Ricardo Santos/Documents/PSO_float/resultados/Pgbest.bin');
% A = fscanf(arquivo,'%f',[colunas linhas]);
